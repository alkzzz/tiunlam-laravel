    ...
    <div class="row">
      <div class="col-md-12">
        <div id="owl-slider" class="owl-carousel">
          ...
          <div class="item"><img src="media/gambar/fullimage1.jpg" alt="The Last of us"><h4>Test Caption</h5><p>Deskripsi Caption</p></div>
          <div class="item"><img src="media/gambar/fullimage2.jpg" alt="GTA V"><h4>Test Caption</h5><p>Deskripsi Caption</p></div>
          <div class="item"><img src="media/gambar/fullimage3.jpg" alt="Mirror Edge"><h4>Test Caption</h5><p>Deskripsi Caption</p></div>
